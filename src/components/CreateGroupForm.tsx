...
const CreateGroupForm = ({ onBack, onSuccess }: CreateGroupFormProps) => {
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Select onValueChange={(value) => handleInputChange('payment_frequency', value)} required>
            ...
            <div>
              ...
              <Select onValueChange={(value) => handleInputChange('payout_schedule', value)} required>
                <SelectTrigger className="bg-gray-700 border-gray-600 text-white">
